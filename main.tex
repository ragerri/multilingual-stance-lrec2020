...
\begin{quote}
\textbf{Tweet:} \emph{Arrimadas ir\'a a Waterloo este domingo para recordar a Puigdemont que  la rep\'ublica no existe  https://t.co/6luAEAj2UD}

\textbf{Our method:} NEUTRAL

\textbf{Manual annotation:} AGAINST/NONE?

\textbf{Language:} Spanish

\textbf{Translation:} \emph{Arrimadas will go to Waterloo this Sunday to remind Puigdemont that the republic does not exist.}
\end{quote}


\begin{quote}
\textbf{Tweet:} \emph{@unprecisionman @jordisalvia Quan l'advocat preguntava sobre certes contradiccions d'un incident concret q havia explicat el Millo, el jutge ha dit q aix\`o no era rellevant per la causa}

\textbf{Our method:} AGAINST

\textbf{Manual annotation:} FAVOR/NONE?
