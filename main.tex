...
\address{$^*$ IXA Group, HiTZ Centre, University of the Basque Country UPV/EHU, Donostia-San Sebasti\'an, Spain\\
\todo[inline]{We need the company's name and Manuel's email}\\
ezotova001@ikasle.ehu.eus, rodrigo.agerri@ehu.eus, author3@hhh.com
...
\todo[inline]{It will be nice to have here a first example of stance detection in Twitter.}
...
\todo[inline]{Enumerate the contributions of this paper: New dataset to work on multilingual stance detection, also to explore cross-lingual approaches in the future. New methodology of annotating a dataset consisting of tweets, state-of-the-art results on a existing benchmark. Finally we contribute both the code and the dataset to facilitate reproducibility of results future research on multilingual stance detection.}
