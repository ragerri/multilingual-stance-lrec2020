...
\address{Affiliation1, Affiliation2, Affiliation3 \\
         IXA NLP Group, University of the Basque Country UPV/EHU, Address2, Address3 \\
...
\end{tabularx}
\caption{Result for the proposed systems trained on TW-1OReferendum ES, in Spanish, and comparison with the best result of IberEval Stance Detection task \cite{Segura-Bedmar18} }
    \end{center}
